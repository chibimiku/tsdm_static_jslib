...
var cookieDomain = "http://www.tsdm.net/";
var msgToTraditionalChinese = "·±ówÖÐÎÄ";
var msgToSimplifiedChinese = "¼òÌåÖÐÎÄ";
var translateButtonId = "GB_BIG";

var currentEncoding = defaultEncoding;
var targetEncodingCookie = "targetEncoding" + cookieDomain.replace(/\./g,"");
var targetEncoding = ( getCookie_lang(targetEncodingCookie) == null ? defaultEncoding : getCookie_lang(targetEncodingCookie) );
...
function translatePage()
{
	if( targetEncoding == 1 )
	{
		...
		setCookie_lang( targetEncodingCookie, targetEncoding, 7 );
		translateBody();
	}
...
function setCookie_lang(name,value,days)
{
	if (days)
	{
		var date = new Date();
